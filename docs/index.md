...
### How to Port:
1.  **Consume the Specification**: Read the [Data Structure Reference](architecture/data-structure.md) to understand the coordinate mapping, word elements, line structure, and metadata arrays.
...
3.  **Map Coordinates & Tap Handlers**:
    ...
    *   In **Vue/Svelte**, wrap the Vanilla Web Component (`view/web`) or build native canvas/SVG-based components.
